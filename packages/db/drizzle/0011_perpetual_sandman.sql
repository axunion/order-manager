...
CREATE TABLE `__new_payments` (
	...
	CONSTRAINT "payments_void_has_reason_chk" CHECK("__new_payments"."voided_at" IS NULL OR "__new_payments"."void_reason" IS NOT NULL)
);
--> statement-breakpoint
INSERT INTO `__new_payments`("id", "store_id", "order_id", "total_amount", "method", "discount_amount", "discount_reason", "paid_at", "voided_at", "void_reason") SELECT "id", "store_id", "order_id", "total_amount", "method", "discount_amount", "discount_reason", "paid_at", "voided_at", "void_reason" FROM `payments`;--> statement-breakpoint
